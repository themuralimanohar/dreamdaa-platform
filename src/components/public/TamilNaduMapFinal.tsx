...
export default function TamilNaduMapFinal() {
              ...
              const geoLayer = L.geoJSON(geojson, {
                ...
                onEachFeature: (feature: any, layer: any) => {
                  ...
                  layer.on('click', (e: any) => {
                    ...
                    // Show popup
                    layer.bindPopup(`<strong>${name}</strong>${district ? `<br/>${getFundingStatusText(district.fundingStatus)} - ${getCoveragePercentage(district)}% covered` : ''}`).openPopup(e.latlng)
                  })
                }
              }).addTo(map)
